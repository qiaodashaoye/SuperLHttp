...
public final class LiveDataResponseCallAdapter<R> implements CallAdapter<R, LiveData<Response<Resource<R>>>> {
    ...
    @Override
    public LiveData<Response<Resource<R>>> adapt(Call<R> call) {
        final MutableLiveData<Response<Resource<R>>> liveDataResponse = new MutableLiveData<>();
