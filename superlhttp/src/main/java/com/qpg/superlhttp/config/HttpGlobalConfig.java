package com.qpg.superlhttp.config;

import com.qpg.superlhttp.SuperLHttp;
import com.qpg.superlhttp.cookie.CookieJarImpl;
import com.qpg.superlhttp.interceptor.GzipRequestInterceptor;
import com.qpg.superlhttp.interceptor.OfflineCacheInterceptor;
import com.qpg.superlhttp.interceptor.OnlineCacheInterceptor;
...
//    }
    ...
    public HttpGlobalConfig setProxy(Proxy proxy) {
        SuperLHttp.getOkHttpBuilder().proxy(checkNotNull(proxy, "proxy == null"));
        return this;
    }
    ...
    public HttpGlobalConfig setConnectTimeout(int timeout, TimeUnit unit) {
        if (timeout > -1) {
            SuperLHttp.getOkHttpBuilder().connectTimeout(timeout, unit);
        } else {
    ...
    public HttpGlobalConfig setWriteTimeout(int timeout, TimeUnit unit) {
        if (timeout > -1) {
            SuperLHttp.getOkHttpBuilder().writeTimeout(timeout, unit);
        } else {
    ...
    public HttpGlobalConfig setReadTimeout(int timeout, TimeUnit unit) {
        if (timeout > -1) {
            SuperLHttp.getOkHttpBuilder().readTimeout(timeout, unit);
        } else {
    ...
    public HttpGlobalConfig setInterceptor(Interceptor interceptor) {
        SuperLHttp.getOkHttpBuilder().addInterceptor(checkNotNull(interceptor, "interceptor == null"));
        return this;
    }
    ...
    public HttpGlobalConfig networkInterceptor(Interceptor interceptor) {
        SuperLHttp.getOkHttpBuilder().addNetworkInterceptor(checkNotNull(interceptor, "interceptor == null"));
        return this;
    }
    ...
    public HttpGlobalConfig cacheOffline(Cache httpCache) {
        networkInterceptor(new OfflineCacheInterceptor(SuperLHttp.getContext()));
        setInterceptor(new OfflineCacheInterceptor(SuperLHttp.getContext()));
        this.httpCache = httpCache;
        return this;
    }
    ...
    public HttpGlobalConfig cacheOffline(Cache httpCache, final int cacheControlValue) {
        networkInterceptor(new OfflineCacheInterceptor(SuperLHttp.getContext(), cacheControlValue));
        setInterceptor(new OfflineCacheInterceptor(SuperLHttp.getContext(), cacheControlValue));
        this.httpCache = httpCache;
        return this;
    }
    ...
    public int getRetryDelayMillis() {
        ...
        if (retryDelayMillis < 0) {
            retryDelayMillis = SuperLVRConfig.DEFAULT_RETRY_DELAY_MILLIS;
        }
    ...
    public int getRetryCount() {
        if (retryCount < 0) {
            retryCount = SuperLVRConfig.DEFAULT_RETRY_COUNT;
        }
        return retryCount;
    }
